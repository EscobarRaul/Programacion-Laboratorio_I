...
def cantidad_tarjertas_descubiertas(lista_tarjetas):
    cantidad = 0
...
def cantidad_tarjertas_visibles_no_descubiertas(lista_tarjetas):
    cantidad = 0
    for tarjeta in lista_tarjetas:
         if (tarjeta["visible"] and tarjeta["descubierto"] == False):
             cantidad += 1
    
    return cantidad

def math(lista_tarjetas):
    aux_primer_tarjeta=""
    aux_segunda_tarjeta=""
